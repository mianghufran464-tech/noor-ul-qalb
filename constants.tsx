...
export const RECITERS = [
  ...
  { id: 'ar.huzayfi', name: 'Ali Al-Huthaifi' },
  { id: 'ar.shuraym', name: 'Saud Al-Shuraim' },
  { id: 'ur.khan', name: 'Urdu Translation (Basit)' }
];
...
export const ICONS = {
  ...
  Tasbeeh: (props: any) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 18a3.75 3.75 0 0 0 .495-7.467 5.99 5.99 0 0 0-1.925 3.546 5.974 5.974 0 0 1-1.533-1.533 3.75 3.75 0 1 0 2.963 5.454Z" />
    </svg>
  ),
};
